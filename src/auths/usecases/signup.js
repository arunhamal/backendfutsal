    ...
    await userModel({
      ...
      if (err) {
        ...
        const params = {
          ...
          html: `<h1>Please click on below link for verification</h1> <br/> <a href="http://localhost:3000/verify/${verificationKey}">Click Here</a>`,
        };
        await notify(params);
      ...
      await forgetPasswordModel({
        ...
        if (err) {
          ...
          const params = {
            ...
            html: `<h1>Please click on below link to verify email</h1> <br/> <a href="http://localhost:3000/forget-password/verify/${verificationKey}">Click Here</a>`,
          };
          await notify(params);
        }
      });
